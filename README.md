...
parses the  response into Python objects Processing of the data was done on a per-account basis. Tests have been done to ensure the calculations
...
These scripts were used as part of my final year project at university.
